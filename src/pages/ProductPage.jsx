                                ...
                                <fieldset className="space-y-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="pl-10 w-full rounded-md border-gray-300 py-2.5 px-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                required
                                                className="pl-10 w-full rounded-md border-gray-300 py-2.5 px-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition appearance-none"
                                            >
                                        ...
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                className="pl-10 w-full rounded-md border-gray-300 py-2.5 px-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition appearance-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                                            >
